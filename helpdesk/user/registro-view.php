<?php
    if(isset($_POST['user_reg']) && isset($_POST['clave_reg']) && isset($_POST['nom_complete_reg'])){
        ...
        $tipoUser_reg=MysqlQuery::RequestPost('tipoUser');

        $asunto="Registro de cuenta HelpDesk Linkbits";
        $cabecera="From: Helpdesk linkbits<luis>";
        ...
        if(MysqlQuery::Guardar("cliente", "nombre_completo, nombre_usuario, email_cliente, clave, tipoUser", "'$nombre_reg', '$user_reg', '$email_reg', '$clave_reg', '$tipoUser_reg'")){
...
<div class="container">
  <div class="row">
      ...
      <div class="panel panel-success">
        ...
        <div class="panel-body">
          <form role="form" action="" method="POST">
            ...
            <!-- tipo de usuario a(tecnico), b(usuariod e tienda o bodega)-->
            <div class="form-group">
              <label><i class="fa fa-user-o"></i>&nbsp;Tipo de Usuario: </label>
    ...
    <div class="col-sm-4 text-center hidden-xs">
      <img src="img/robot1.png" class="img-responsive" alt="Image">
