...
}else if($_SESSION['nombre']!="" && $_SESSION['clave']!="" && $_SESSION['tipo']=="user"  && $_SESSION['tipoUser'] == 'A'){
?>
        <div class="container">
          <div class="row">
            <div class="col-sm-2">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido Técnico, aqui se muestran todos los Tickets los cuales podras modificar e imprimir.</p>
            </div>
          </div>
        </div>
            <?php
