...
<script src="signature_pad.js"></script>';
    ...
    $ruta1 = 'fotos/no-imagen.png';
    $ruta2 = 'fotos/no-imagen.png';
    $ruta3 = 'fotos/no-imagen.png';
    ...
    if(isset($_FILES["nuevaImagen"]["tmp_name"])){
      ...
      if($_FILES["nuevaImagen"]["type"] == "image/jpeg"){
        ...
        $ruta1 = "/fotos/".md5($_POST["id_edit"]).".jpg";
      ...
      if($_FILES["nuevaImagen"]["type"] == "image/png"){
        ...
        $ruta1 = "fotos/".md5($_POST["nuevaImagen"]).".png";
    ...
    $agente=  MysqlQuery::RequestPost('agente');
    $imagen1= MysqlQuery::RequestPost('$ruta');
		...
		if(MysqlQuery::Actualizar("ticket", "estado_ticket='$estado_edit',agente='$agente', solucion='$solucion_edit', foto1='$imagen1'", "id='$id_edit'")){
                ...
                <form class="form-horizontal" role="form" action="" method="POST">
                            ...
                            <div class='col-sm-10'>
                                <div class="input-group">
                                    <select class="form-control" name="agente">
                                        <option value="<?php echo $reg['agente']?>"><?php echo $reg['agente']?> (Actual)</option>
                        ...
                        <div class="form-group">
                          ...
                          <input type="file" class="nuevaImagen" name="nuevaImagen" id="nuevaImagen">
                            ...
                            <img src="img/error.png" class="img-thumbnail previsualizar" width="100px">
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <DIV>
                          <a href="./admin/firma.html" target="_blank"><label > Presiona Aquí para tu Firma </label></a>                         
                          <br>
