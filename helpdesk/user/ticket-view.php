<?php if(isset($_SESSION['nombre']) && isset($_SESSION['tipo'])){
        ...
        if(isset($_POST['fecha_ticket']) && isset($_POST['name_ticket']) && isset($_POST['email_ticket'])){
          ...
          $area= MysqlQuery::RequestPost('area_ticket');
          ...
          $cabecera="From: Soporte Tecnico <luis@linkbits.com.mx>";
          ...
          if(MysqlQuery::Guardar("ticket", "fecha, nombre_usuario, email_cliente, area ,departamento, asunto, mensaje, estado_ticket, serie", "'$fecha_ticket', '$nombre_ticket', '$email_ticket','$area', '$departamento_ticket', '$asunto_ticket', '$mensaje_ticket', '$estado_ticket','$id_ticket'")){
                ...
                <div class="panel-body">
                  <div class="row">
                    <div class="col-sm-4 text-center">
                      <br><br><br>
                      <img src="img/robot1.png" Width="200" Height="200"><br><br>
                    ...
                    <div class="col-sm-8">
                      <form class="form-horizontal" role="form" action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class='col-sm-10'>
                                <div class="input-group">
                                    <input class="form-control" type="text" id="fechainput" placeholder="Fecha" name="fecha_ticket" required="" readonly value="<?php echo date("m/d/y"); ?>">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <div class='input-group'>
                                <input type="text" class="form-control" value="<?php echo $_SESSION['nombre']?>" placeholder="Nombre" required="" pattern="[a-zA-Z ]{1,30}" name="name_ticket" title="Nombre Apellido" readonly>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <div class='input-group'>
                                <input type="email" class="form-control" id="inputEmail3" value="<?php echo $_SESSION['email']?>" placeholder="Email" name="email_ticket" required="" title="Ejemplo@dominio.com" readonly>
                          ...
                          <div class="col-sm-10">
                              <div class='input-group'>
                                <select class="form-control" name="area_ticket">
                                  <option value="CEDIS P105">CEDI P105</option>
                                  <option value="CEDIS VALLEJO">CEDIS VALLEJO</option>
                                  <option value="BOD ">BOD 31</option>
                                  <option value="FLORIDA">FLORIDA</option>
                                  <option value="ARGENTINA">ARGENTINA</option>
                                  <option value="CORREGIDORA">CORREGIDORA</option>
                                  <option value="CEYLAN">CEYLAN</option>
                                  <option value="SUCURSAL NY">SUCURSAL NY</option>
                                  <option value="SUCURSAL WA">SUCURSAL WA</option>
                                  <option value="SUCURSAL IZA">SUCURSAL IZA</option>
                                  <option value="OFICINAS 43">OFICINAS 43</option>
                        ...
                        <div class="form-group">
                          <label  class="col-sm-2 control-label">Detalla claramente su problema</label>
                          <div class="col-sm-10">
                            <textarea class="form-control" rows="3" placeholder="Detalle claramente el problema actual" name="mensaje_ticket" required=""></textarea>
                          </div>
                        </div>
