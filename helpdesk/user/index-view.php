...
<div class="container">
  <div class="row">
    <div class="col-md-12">
        <h1 class="text-center text-info">Conoce Nuestros Procesos</h1>
        <input type="hidden" value="<?php echo $_SESSION['tipoUser']; ?>" id="tipoUser" name="tipoUser">
        <input type="hidden" value="<?php echo $_SESSION['nombre']; ?>" id="nombre_usuario" name="nombre_usuario">
        <input type="hidden" value="<?php echo $_SESSION['nombre_completo']; ?>" id="nombre_comp" name="nombre_comp">
    </div>
  </div>
</div>
<br>
