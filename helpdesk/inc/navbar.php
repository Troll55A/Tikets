...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php"><i class="fa fa-activity"></i>&nbsp;&nbsp;Sistema de Gestión de Tickets HelpDesk</a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <!-- usuarios -->
                        <?php if($_SESSION['tipo']=="user" && $_SESSION["tipoUser"] == 'A'): ?>
                        <li>
                            <a href="admin.php?view=ticketadmin"><span class="glyphicon glyphicon-comment"></span>&nbsp;&nbsp;Administrar tickets</a> <!--no hace nada-->
                        </li>
                        <li>
                            <a href="./index.php?view=configuracion"><i class="fa fa-cogs"></i>&nbsp;&nbsp;Configuracion</a>
                        </li> 
                        <?php elseif($_SESSION['tipo']=="user" && $_SESSION["tipoUser"] == 'B'):; ?>
                        <li>
                            <a href="./index.php?view=configuracion"><i class="fa fa-cogs"></i>&nbsp;&nbsp;Configuracion</a>
                        </li> 
                        <?php endif; ?> 
