<?php if(!$_SESSION['nombre']==""&&!$_SESSION['tipo']==""){ 
        ...
        if(isset($_POST['name_complete_update']) && isset($_POST['old_user_update']) && isset($_POST['new_user_update']) && isset($_POST['old_pass_update']) && isset($_POST['new_pass_update'])){
          ...
          $tipoUser_update=MysqlQuery::RequestPost('tipoUser_update');
          ...
          if(mysqli_num_rows($sql)>=1){
            MysqlQuery::Actualizar("cliente", "nombre_completo='$nombre_complete_update', nombre_usuario='$new_user_update', email_cliente='$email_update', clave='$new_pass_update', tipoUser='$tipoUser_update'", "nombre_usuario='$old_user_update' and clave='$old_pass_update'");
        ...
        <div class="container">
          <div class="row well">
            ...
            <div class="col-sm-9 lead">
              <h2 class="text-info">Bienvenido a la configuración</h2>
              ...
              <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $_SESSION['nombre_completo'];?>" placeholder="Nombre completo" name="name_complete_update" required="" pattern="[a-zA-Z ]{1,40}" title="Nombre Apellido" maxlength="40" readonly>
                    </div>
                    <div class="form-group">
                      <label class="text-danger"><i class="fa fa-user"></i>&nbsp;&nbsp;Nombre de usuario actual</label>
                      <input type="text" class="form-control" value="<?php echo $_SESSION['nombre'];?>" placeholder="Nombre de usuario actual" name="old_user_update" required="" pattern="[a-zA-Z0-9 ]{1,30}" title="Ejemplo7" maxlength="20" readonly>
                    </div>
                    ...
                    <div class="form-group">
                      <label class="text-danger"><i class="fa fa-envelope-o"></i>&nbsp;&nbsp;Email</label>
                      <input type="email" class="form-control" value="<?php echo $_SESSION['email'];?>" placeholder="Escriba su email" name="email_update" required="" readonly>
                    </div>
                    ...
                    <div class="form-group">
                      <label class="text-primary"><i class="fa fa-user-o text-primary"></i>&nbsp;&nbsp;Tipo de Usuario: </label>
                      
                      <select name="tipoUser_update"   class="form-control ">
                        <?php if($_SESSION['tipoUser'] == 'A') {?>
                        <option value="A" default>Soporte Técnico</option>
                        <option value="B">Sucursal o Bodega</option>
                        <?php }else{ ?>
                        <option value="B" default>Sucursal o Bodega</option>
                        <option value="A">Soporte Técnico</option>
                        <?php }?>
                      </select>
                    </div>
