...
<html>
    ...
    <body>   
          ...
          <div class="row">
            <div class="col-sm-12">
              <div class="page-header">
                <h1 class="animated lightSpeedIn">Linkbits <small>HelpDesk</small></h1>
                <span class="label label-danger">Linkbits S.A de C.V</span>
        ...
        <?php
            if(isset($_GET['view'])){
                $content=$_GET['view'];
                $WhiteList=["index","productos","soporte","ticket","ticketcon","registro","configuracion"]; //display al acceso de los menuso del sistema 
